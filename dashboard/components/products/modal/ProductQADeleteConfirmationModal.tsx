...
const ProductQADeleteConfirmationModal = ({
  isOpenDelete,
  handleCloseDelete,
  deleteData,
}: any) => {
  ...
  const handleDeleteCategory = async () => {
    await deleteProductQA({ productQaId: deleteData?.productQaId });
  };
        ...
        <Modal.Body className="p-3 ">
          ...
          <div className=" ">
            ...
            <div className="mt-5 border p-5 border-black/10 rounded-lg">
              <h2>Product Name : {deleteData?.product?.productName}</h2>
            </div>
...
export default ProductQADeleteConfirmationModal;
